...
\subsubsection{Measure of time and space}\label{sec:m1:measure_time_space}
    ...
    The radial coordinate in the FLRW line element, ~\cref{eq:m1:theory:fundamentals:FLWR_line_element}, is given in terms of the comoving distance and the curvature density today $\O_{k0}$ as:
