...
\subsubsection{Line of sight integration}
    ...
    \end{equation}
    where $j_l\left[k(\eta_0-\eta(x))\right]$ are the spherical Bessel functions. $\mathcal{S}(k,x)$ is known as the \textit{source function} and is given by:
